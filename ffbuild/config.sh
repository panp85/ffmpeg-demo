...
extralibs_avcodec="-pthread -lm -lz -L/usr/local/lib -lx264"
extralibs_avformat="-lm -lz"
extralibs_avdevice="-lXv -lX11 -lXext -lm -lxcb -lxcb-shape -lxcb -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb -lasound -lSDL2"

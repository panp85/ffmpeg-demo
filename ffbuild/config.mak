...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-debug --enable-libx264 --enable-libxvid --disable-yasm --disable-asm --enable-static --enable-shared --enable-gpl --enable-version3 --enable-nonfree --enable-ffplay --prefix=/home/panpan/player/newest_ffmpeg/ffmpeg/test/ --extra-cflags=-g --extra-ldflags=-g --disable-optimizations
...
CFLAGS=  -g -std=c11 -fPIC -pthread -I/usr/local/include -I/usr/include/alsa     -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign  -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
EXTRALIBS-avdevice=-lm -lxcb -lxcb-shm -lxcb -lxcb-shape -lxcb -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb -lasound
